...
const PROVIDERS = [
  { id: 'food-a', category: 'Food', subcategory: 'Food Delivery', name: 'Swiggy', icon: '🍔', authType: 'otp', url: 'https://www.swiggy.com', loginUrl: 'https://www.swiggy.com', desc: 'Account-specific menu and cart pricing is available.', regions: ['all'] },
  ...
  { id: 'train-d', category: 'Food', subcategory: 'Train Food', name: 'Travelkhana', icon: '🚂', authType: 'google', url: 'https://www.travelkhana.com', loginUrl: 'https://www.travelkhana.com/login', desc: '', regions: ['station', 'junction', 'terminal', 'cantt', 'railway'] }
];
