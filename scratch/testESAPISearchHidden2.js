...
(async () => {
  ...
  console.log('Search Results JSON keys:', Object.keys(JSON.parse(text2).data.preload_data));
  console.log('Is there product data?', JSON.parse(text2).data.preload_data.products ? 'Yes' : 'No');
